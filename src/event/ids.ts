...
/** ev=Event ix=Interaction att=Attempt ctx=ContextSnapshot ctxe=ContextEpoch bs=BatonSession hs=HarnessSession t=Turn m=Message tc=ToolCall pl=Plan arv=ApprovalReview pi=PluginInstance pr=PluginResource */
