...
const closedChoice = context.verbs.ask({
  timeoutMs: 1_000,
  title: "Execution",
...
const choiceOrText = context.verbs.ask({
  timeoutMs: 1_000,
  title: "Execution",
  prompt: "How should this run?",
  choices: [
...
const freeText = context.verbs.ask({
  timeoutMs: 1_000,
  title: "Reason",
  prompt: "Why?",
  allowOther: true,
...
context.verbs.ask({ timeoutMs: 1_000, title: "Reason", prompt: "Why?" });
